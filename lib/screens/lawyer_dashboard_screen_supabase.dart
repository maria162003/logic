    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => Scaffold(
          ...
          body: _LawyerChatView(caseData: caseData),
        ),
      ),
    );
  }
...
class _LawyerChatView extends StatefulWidget {
  ...
  const _LawyerChatView({required this.caseData});
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Cliente: ${widget.caseData['client_name'] ?? 'Desconocido'}',
                      style: GoogleFonts.poppins(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isFromLawyer ? AppColors.primary : Colors.grey[300],
                          borderRadius: BorderRadius.circular(18),
                        ),
                        child: Text(
                          message['message'] ?? '',
                          style: GoogleFonts.poppins(
                            color: isFromLawyer ? Colors.black : Colors.black87,
                            fontSize: 14,
                          ),
                        ),
                      ),
