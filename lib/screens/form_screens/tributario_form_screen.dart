          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTextField(
                  controller: _nitController,
                  label: 'Número de Documento Tributario',
                  icon: Icons.document_scanner,
                  keyboardType: TextInputType.text,
                  hintText: 'Número del documento tributario',
                ),
                ...
                _buildTextField(
                  ...
                  maxLines: 3,
                  hintText: 'Lista los documentos que tienes relacionados con el caso',
                ),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final success = await marketplaceProvider.createCase(
          ...
          category: 'Tributario', // Categoría general en lugar del tipo específico
