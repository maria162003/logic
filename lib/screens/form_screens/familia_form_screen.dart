...
class FamiliaFormScreen extends StatefulWidget {
  const FamiliaFormScreen({Key? key}) : super(key: key);

  @override
  State<FamiliaFormScreen> createState() => _FamiliaFormScreenState();
}

class _FamiliaFormScreenState extends State<FamiliaFormScreen> {
  ...
  String _tipoCaso = 'Divorcio';
  String _estadoCivil = 'Casado(a)';
  ...
  final List<String> _estadosCiviles = ['Soltero(a)', 'Casado(a)', 'Unión Libre', 'Divorciado(a)', 'Viudo(a)'];
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        'Complete la información para su consulta familiar',
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      items: _estadosCiviles.map((String estado) {
                ...
                _buildTextField(
                  ...
                  label: 'Nombre del Cónyuge/Pareja',
                  icon: Icons.people,
                  hintText: 'Solo si aplica',
                ),
                ...
                // Información del Caso Familiar
                _buildSectionTitle('Información del Caso Familiar'),
                const SizedBox(height: 16),
                
                // Tipo de caso familiar
                Container(
                  decoration: BoxDecoration(
                    color: Colors.grey[900],
                    borderRadius: BorderRadius.circular(12),
                  ...
                  child: Padding(
                    ...
                    child: DropdownButtonFormField<String>(
                      value: _tipoCaso,
                      decoration: InputDecoration(
                        labelText: 'Tipo de Caso Familiar',
                        labelStyle: TextStyle(color: AppColors.primary),
                        border: InputBorder.none,
                ...
                _buildTextField(
                  ...
                  validator: (value) {
                    if (value?.isEmpty ?? true) {
                      return 'Por favor describa su caso familiar';
                    }
                    return null;
                  },
                  hintText: 'Describa detalladamente la situación familiar que requiere asesoría legal',
                ),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final success = await marketplaceProvider.createCase(
          ...
          category: 'Familiar', // Categoría general en lugar del tipo específico
